...
const Timeline = () => {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      type: "work",
      description:
        "Started my professional journey, learning and applying fundamental programming concepts.",
      achievements: [
    ...
    },
    {
      ...
      type: "learning",
      description:
        "Began my coding journey through online courses, tutorials, and hands-on projects.",
      achievements: [
        "Completed 10+ online courses",
        "Built first personal projects",
        "Joined developer communities",
        "Started contributing to GitHub",
      ],
